...
import { Download, Share2, RefreshCw, Flag, MapPin, AlertTriangle, LayoutDashboard, Dna, Pill, Beaker } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        {/* Mutation Tab - Content abbreviated for length */}
        ...
        {/* Drug Candidates Tab - Placeholder */}
