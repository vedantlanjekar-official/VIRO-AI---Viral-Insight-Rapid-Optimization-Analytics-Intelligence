...
export default function Result() {
  ...
  const recommendations = [
    { title: 'Priority', description: 'Conduct in-vitro binding validation of Compound-A-7821 against spike protein', score: 95 },
    { title: 'Vaccine Update', description: 'Update vaccine epitope panel to include S:484K and S:501Y mutations', score: 88 },
    { title: 'Surveillance', description: 'Increase genomic surveillance in Maharashtra and neighboring states', score: 82 },
    { title: 'Clinical Monitoring', description: 'Track breakthrough infections in vaccinated populations', score: 75 },
    { title: 'Public Health', description: 'Implement enhanced contact tracing protocols in detected regions', score: 70 }
  ];
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          {/* Actionable Recommendations - New Layout matching Deadliness Score */}
            ...
            <CardContent>
              <div className="space-y-4">
                {recommendations.map((rec, index) => (
                  <div key={index}>
                    <div className="flex justify-between text-sm mb-1">
                      <span className="font-semibold text-[#0B2336]">{rec.title}</span>
                      <span className="font-semibold text-blue-600">{rec.score}/100</span>
                    </div>
                    <p className="text-sm text-[#4A6A7A] mb-2">{rec.description}</p>
                    <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-blue-500" style={{ width: `${rec.score}%` }} />
                    </div>
                  </div>
                ))}
              </div>
              <Alert className="mt-6">
                <AlertDescription className="text-sm">
                  <strong>Implementation Priority:</strong> Execute recommendations in descending order of priority score. High-priority items (>80) require immediate action within 48 hours.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
        ...
        <TabsContent value="mutation" className="space-y-6">
          ...
          {/* Detailed Mutation Analysis Cards - New Side-by-Side Layout */}
          <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border-l-2 border-blue-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">I. Genomic-Level Mutation Description</h3>
                        <ul className="space-y-2">
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Nucleotide Substitution:</span>
                            <span className="ml-2 font-bold text-[#0B2336] font-mono">{data.genomicLevel.nucleotideSubstitution}</span>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Mutation Type:</span>
                            <span className="ml-2 font-semibold text-[#0B2336]">{data.genomicLevel.mutationType}</span>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Genomic Region:</span>
                            <span className="ml-2 font-semibold text-[#0B2336]">{data.genomicLevel.genomicRegion}</span>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Codon Change:</span>
                            <span className="ml-2 font-bold text-[#0B2336] font-mono">{data.genomicLevel.codonChange}</span>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Classification:</span>
                            <Badge variant="secondary" className="ml-2 text-sm">{data.genomicLevel.synonymous}</Badge>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="border-l-2 border-green-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">III. Selective Pressure & Evolutionary Indicators</h3>
                        <ul className="space-y-2">
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">dN/dS Ratio:</span>
                            <span className="ml-2 text-lg font-bold text-[#0B2336]">{data.selectivePressure.dNdS}</span>
                            <Badge variant="outline" className="ml-2 text-xs">Positive Selection</Badge>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Conservation Score:</span>
                            <span className="ml-2 font-semibold text-[#0B2336]">{data.selectivePressure.conservationScore}</span>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Co-Evolution Pattern:</span>
                            <span className="ml-2 font-semibold text-[#0B2336]">{data.selectivePressure.coEvolution}</span>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="border-l-2 border-red-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">V. Predicted Impact on Receptor Binding</h3>
                        <ul className="space-y-2">
                          {Object.entries(data.receptorBinding).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                      ...
                      <div className="border-l-2 border-indigo-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VII. Viral Fitness & Replication Potential</h3>
                        <ul className="space-y-2">
                      ...
                      <div className="border-l-2 border-teal-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">IX. Lineage Emergence Forecasts</h3>
                        <div className="space-y-3">
                          <div>
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider block mb-1">New Lineage Probability</span>
                            <div className="flex items-center gap-3">
                              <div className="flex-1 h-3 bg-gray-200 rounded-full overflow-hidden">
                                <div className="h-full bg-teal-500" style={{ width: data.lineageEmergence.newLineageProbability }} />
                              </div>
                              <span className="text-lg font-bold text-teal-600 min-w-[50px]">{data.lineageEmergence.newLineageProbability}</span>
                            </div>
                          </div>
                          <ul className="space-y-2">
                            <li className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Phylogenetic Pathway:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{data.lineageEmergence.phylogeneticPathway}</span>
                            </li>
                            <li className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Co-Mutation Synergy:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{data.lineageEmergence.coMutationSynergy}</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    {/* Right Column - Sections II, IV, VI, VIII */}
                    <div className="space-y-6">
                      {/* Section II */}
                      <div className="border-l-2 border-purple-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">II. Mutation Probability Metrics</h3>
                        <div className="space-y-3">
                          <div>
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider block mb-1">AI-Derived Probability Score</span>
                            <div className="flex items-center gap-3">
                              <div className="flex-1 h-3 bg-gray-200 rounded-full overflow-hidden">
                                <div className="h-full bg-purple-500" style={{ width: `${data.probability.aiScore * 100}%` }} />
                              </div>
                              <span className="text-lg font-bold text-purple-600 min-w-[50px]">{data.probability.aiScore}</span>
                            </div>
                          </div>
                          <ul className="space-y-2">
                            <li className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Historical Frequency:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{data.probability.historicalFrequency}</span>
                            </li>
                            <li className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Fixation Likelihood:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{data.probability.fixationLikelihood}</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="border-l-2 border-orange-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">IV. Protein Structural Consequences</h3>
                        <ul className="space-y-2">
                      ...
                      <div className="border-l-2 border-yellow-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VI. Immune Evasion & Antigenicity Shifts</h3>
                        <ul className="space-y-2">
                      ...
                      <div className="border-l-2 border-pink-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VIII. Pathogenicity Contribution</h3>
                        <div className="space-y-3">
                          <div>
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider block mb-1">Pathogenicity Score Contribution</span>
                            <div className="flex items-center gap-3">
                              <div className="flex-1 h-3 bg-gray-200 rounded-full overflow-hidden">
                                <div className="h-full bg-pink-500" style={{ width: `${parseInt(data.pathogenicity.contribution)}%` }} />
                              </div>
                              <span className="text-lg font-bold text-pink-600 min-w-[70px]">{data.pathogenicity.contribution}</span>
                            </div>
                          </div>
                          <ul className="space-y-2">
                            <li className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Tropism Impact:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{data.pathogenicity.tropismImpact}</span>
                            </li>
                            <li className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Viral Load Threshold:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{data.pathogenicity.viralLoadThreshold}</span>
                            </li>
                          </ul>
                        </div>
                      </div>
        ...
        <TabsContent value="drugs" className="space-y-6">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-[#0B2336] font-mono">{drug.formula}</p>
                        </div>
                        <div>
          ...
          {/* Detailed Drug Analysis - New Side-by-Side Layout */}
          <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription className="text-base mt-1">
                        Formula: <span className="font-bold font-mono">{drug.formula}</span> | Comprehensive Scientific Analysis
                      </CardDescription>
                    </div>
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                      {/* Section I */}
                      <div className="border-l-2 border-blue-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">I. Molecular Identity & Structure</h3>
                        <ul className="space-y-2">
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Chemical Name:</span>
                            <span className="ml-2 font-semibold text-[#0B2336]">{drug.molecularIdentity.chemicalName}</span>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">Unique ID:</span>
                            <span className="ml-2 font-bold text-[#0B2336] font-mono">{drug.molecularIdentity.uniqueID}</span>
                          </li>
                          <li className="text-sm">
                            <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider block mb-1">InChI String:</span>
                            <span className="text-xs font-mono text-[#0B2336] break-all bg-gray-50 p-2 rounded block">{drug.molecularIdentity.inchi}</span>
                          </li>
                        </ul>
                      </div>
                      ...
                      {/* Section III */}
                      <div className="border-l-2 border-green-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">III. Interaction Map With Viral Protein</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.interactionMap).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section V */}
                      <div className="border-l-2 border-red-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">V. Physicochemical Properties</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.physicochemical).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section VII */}
                      <div className="border-l-2 border-indigo-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VII. Toxicological & Safety-Signal Models</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.toxicology).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              {key === 'amesMutagenicity' || key === 'painsFilter' ? (
                                <Badge variant="secondary" className="ml-2 text-sm">{value}</Badge>
                              ) : (
                                <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                              )}
                            </li>
                      ...
                      {/* Section IX */}
                      <div className="border-l-2 border-teal-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">IX. Multi-Conformation & Ensemble Analysis</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.ensembleAnalysis).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      <div className="border-l-2 border-cyan-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">XI. Chemical Diversity & Novelty Analysis</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.chemicalDiversity).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                    ...
                    <div className="space-y-6">
                      {/* Section II */}
                      <div className="border-l-2 border-purple-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">II. Binding Affinity & Interaction Strength</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.bindingMetrics).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-bold text-[#0B2336]">{value}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                      ...
                      {/* Section IV */}
                      <div className="border-l-2 border-orange-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">IV. Structural Stability of Ligand-Protein Complex</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.structuralStability).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section VI */}
                      <div className="border-l-2 border-yellow-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VI. ADME Scientific Predictions</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.adme).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section VIII */}
                      <div className="border-l-2 border-pink-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VIII. Comparative Activity Scores</h3>
                        <div className="space-y-3">
                          {Object.entries(drug.comparativeScores).map(([key, value]) => (
                            <div key={key}>
                              <div className="flex justify-between text-xs mb-1">
                                <span className="font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}</span>
                      ...
                      {/* Section X */}
                      <div className="border-l-2 border-red-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">X. Resistance Vulnerability Analysis</h3>
                        <ul className="space-y-2">
                          {Object.entries(drug.resistanceVulnerability).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
        ...
        <TabsContent value="modifications" className="space-y-6">
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="font-mono font-bold text-[#0B2336] text-lg">{mod.oldFormula}</p>
                        </div>
                        <div>
                          <p className="text-sm text-[#4A6A7A] mb-2">Suggested Formula</p>
                          <p className="font-mono font-bold text-green-600 text-lg">{mod.newFormula}</p>
                        </div>
                      </div>
                      <div>
          ...
          {/* Detailed Modification Analysis - New Side-by-Side Layout */}
          <div className="space-y-6">
                ...
                <CardHeader className="bg-gradient-to-r from-green-50 to-transparent pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription className="text-base mt-1">
                        <span className="font-mono font-bold">{mod.baseFormula}</span> → <span className="font-mono font-bold text-green-600">{mod.modifiedFormula}</span>
                      </CardDescription>
                    </div>
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                      {/* Section I */}
                      <div className="border-l-2 border-blue-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">I. Molecular Modification Identity</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.modificationIdentity).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section III */}
                      <div className="border-l-2 border-green-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">III. Physicochemical Property Changes</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.physicochemicalChanges).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section V */}
                      <div className="border-l-2 border-red-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">V. Electronic & Quantum-Level Effects</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.electronicEffects).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section VII */}
                      <div className="border-l-2 border-indigo-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VII. Solubility & Permeability Changes</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.solubilityPermeability).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section IX */}
                      <div className="border-l-2 border-teal-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">IX. Toxicity-Related Chemical Signatures</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.toxicitySignatures).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              {key === 'painsFilter' ? (
                                <Badge variant="secondary" className="ml-2 text-sm">{value}</Badge>
                      ...
                      {/* Section XI */}
                      <div className="border-l-2 border-lime-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">XI. Comparative Scoring Table</h3>
                        <div className="space-y-3">
                    ...
                    <div className="space-y-6">
                      {/* Section II */}
                      <div className="border-l-2 border-purple-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">II. Structural & Conformational Effects</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.structuralEffects).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section IV */}
                      <div className="border-l-2 border-orange-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">IV. Predicted Binding Affinity Effects</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.bindingAffinityEffects).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section VI */}
                      <div className="border-l-2 border-yellow-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VI. Stability & Degradation Properties</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.stabilityDegradation).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section VIII */}
                      <div className="border-l-2 border-pink-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">VIII. ADME-Related Parameter Shifts</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.admeShifts).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
                      ...
                      {/* Section X */}
                      <div className="border-l-2 border-cyan-200 pl-4">
                        <h3 className="text-base font-bold text-[#0B2336] mb-3 uppercase tracking-wide">X. Synthetic Feasibility Metrics</h3>
                        <ul className="space-y-2">
                          {Object.entries(mod.syntheticFeasibility).map(([key, value]) => (
                            <li key={key} className="text-sm">
                              <span className="text-xs font-medium text-[#4A6A7A] uppercase tracking-wider">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                              <span className="ml-2 font-semibold text-[#0B2336]">{value}</span>
                            </li>
